                    ...
                    <fo:table table-layout="fixed" width="100%">
                      ...
                      <fo:table-body>
                        ...
                        <fo:table-row font-size="11pt">
                          ...
                          <fo:table-cell>
                            <fo:block xsl:use-attribute-sets="itemBold" color="#ff0000">
                          ...
                          <fo:table-cell number-columns-spanned="6" >
                            <fo:table table-layout="fixed" width="100%">
                              ...
                              <fo:table-body>
                                ...
                                <fo:table-row>
                                  <fo:table-cell number-columns-spanned="3">
                                    <fo:block  margin-top="3mm" font-size="10pt" xsl:use-attribute-sets="labelNormal">
                                      <fo:table table-layout="fixed" width="100%">
                                        ...
                                        <fo:table-body>
                                          <fo:table-row>
                                            <fo:table-cell>
                                              ...
                                              <fo:block text-align="center">
                                                <fo:inline font-size="10pt" xsl:use-attribute-sets="labelNormal"> </fo:inline>
                                              </fo:block>
                                              <fo:block text-align="center" xsl:use-attribute-sets="labelNormal">
                                                <fo:wrapper  xsl:use-attribute-sets="labelBold" font-size="11pt">Ngày chuyển đổi: </fo:wrapper>
												<!-- <fo:block font-size="10pt" xsl:use-attribute-sets="labelNormal">26/06/2020</fo:block> -->
