...
<xsl:stylesheet xmlns:foo="http://sinvoice.com.vn"  xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:inv="http://laphoadon.gdt.gov.vn/2014/09/invoicexml/v1" exclude-result-prefixes="fo" version="2.0">
  ...
  <xsl:attribute-set name="invoiceName">
    ...
    <xsl:attribute name="color">#1C3270</xsl:attribute>
  ...
  <xsl:attribute-set name="boxLarge">
    ...
    <xsl:attribute name="border-color">#1C3270</xsl:attribute>
  ...
  <xsl:attribute-set name="dataInfoInvoice">
    <!--font-size="10pt" space-after="4mm" text-align="left" margin-top="0mm" border="0.5pt solid" border-color="#4C3F57"-->
    ...
    <xsl:param name="num" />
		<xsl:if test="string-length($num)">
			...
			<xsl:call-template name="splitstring">
				<xsl:with-param name="num" select="substring-after($num, '|')" />
			</xsl:call-template>
		</xsl:if>
	</xsl:template>
  ...
  <xsl:template match="/invoice" name="invoiceTemplate">
                ...
                <fo:table-body>
                  <fo:table-row>
                    <fo:table-cell border-top="dotted">
                      ...
                      <fo:block text-align="center">
                        <fo:wrapper font-size="7pt" xsl:use-attribute-sets="labelItalic">
                        ...
                        <fo:wrapper font-size="7pt" xsl:use-attribute-sets="labelNormal">
                          <xsl:value-of select="DLHDon/TTChung/TTKhac/TTin[TTruong='Mabimat']/DLieu"/>
                        </fo:wrapper>
                      </fo:block>
                    </fo:table-cell>
                  </fo:table-row>
        ...
        <fo:flow flow-name="xsl-region-body">
          <fo:table table-layout="fixed" text-align="center" width="100%">
            ...
            <fo:table-header>
              <fo:table-row>
                <fo:table-cell>
                 <fo:block-container absolute-position="fixed" text-align="center" display-align="before" top="105mm" left="10mm" right="10mm">
                    <fo:block>
                      <fo:external-graphic content-height="scale-to-fit" content-width="scale-to-fit" max-height="18cm" max-width="100%"  scaling="uniform"  src="url('watermark.png')"/>
                    </fo:block>
                  </fo:block-container>
                  <fo:block-container  absolute-position="fixed" text-align="center" display-align="before" top="100mm" left="10mm" right="10mm">
                    <fo:block>
              ...
              <fo:table-row border-collapse="collapse" width="100%">
                ...
                <fo:table-cell border-collapse="collapse" xsl:use-attribute-sets="header">
                  ...
                  <fo:block>
                    <fo:block font-size="13pt" xsl:use-attribute-sets="invoiceNameItalic">(VAT INVOICE)</fo:block>
                  </fo:block>
                  <fo:block font-size="10pt">
                    <fo:block xsl:use-attribute-sets="headerNote" font-weight="bold">HÓA ĐƠN CHUYỂN ĐỔI TỪ HÓA ĐƠN ĐIỆN TỬ</fo:block>
                  </fo:block>
                  <fo:block font-size="10pt">
                    <fo:block xsl:use-attribute-sets="headerNoteItalic" >(Invoice converted from electronic invoice)</fo:block>
                  </fo:block>
                ...
                <fo:table-cell border-collapse="collapse">
                  <fo:block xsl:use-attribute-sets="dataInfoInvoice" padding-top="2mm">
                    ...
                    <fo:table table-layout="fixed" width="100%">
                      ...
                      <fo:table-body>
                        <fo:table-row font-size="10pt">
                          <fo:table-cell>
                            <fo:block xsl:use-attribute-sets="labelNormal">
                              <fo:wrapper xsl:use-attribute-sets="itemBold">Mẫu số </fo:wrapper>
                        ...
                        <fo:table-row>
                          ...
                          <fo:table-cell>
                            <fo:block color="red" font-size="14pt" xsl:use-attribute-sets="itemBold">
                                    ...
                                    <fo:table-cell padding-left="2mm">
                                      <fo:block font-size="10pt">
                                        <fo:table table-layout="fixed" width="100%">
                                          ...
                                          <fo:table-column column-width="77.5%"/>
                                          <fo:table-body>
                                            <fo:table-row>
                                              <fo:table-cell >
                                                <fo:block margin-bottom="0pt" font-size="10pt" text-align="left" xsl:use-attribute-sets="labelNormal">
                                                  <fo:wrapper margin-bottom="0pt" xsl:use-attribute-sets="labelBold">Đơn vị bán hàng </fo:wrapper>
                                                  <fo:wrapper margin-bottom="0pt" xsl:use-attribute-sets="labelItalic">(Seller): </fo:wrapper>
                                                </fo:block>
                                              </fo:table-cell>
                                              <fo:table-cell>
                                                <fo:block margin-bottom="0pt" font-size="10pt" text-align="left" xsl:use-attribute-sets="labelNormal">
                                                  <fo:inline margin-bottom="0pt" xsl:use-attribute-sets="labelBold">
											 ...
											 <fo:table-row>
                                              <fo:table-cell>
                                                <fo:block margin-top="0pt" font-size="10pt" text-align="left" xsl:use-attribute-sets="labelNormal">
                                                  
                                                </fo:block>
                                              </fo:table-cell>
                                              <fo:table-cell>
                                                <fo:block margin-top="0pt" font-size="10pt" text-align="left" xsl:use-attribute-sets="labelNormal">
                                                  <fo:wrapper  margin-top="0pt" xsl:use-attribute-sets="labelItalic">GREEN SEA TRANSPORT LOGISTICS COMPANY LIMITED</fo:wrapper>
                                                </fo:block>
                                              </fo:table-cell>
                                            </fo:table-row>
                                          </fo:table-body>
                                            ...
                                            <fo:table-row>
                                              <fo:table-cell>
                                                <fo:block font-size="10pt" text-align="left"  xsl:use-attribute-sets="labelNormal">
                                                  ...
                                                  <fo:wrapper font-size="10pt" xsl:use-attribute-sets="labelItalic">(Account No.): </fo:wrapper>
                                                </fo:block>
                                              </fo:table-cell>
                                              <fo:table-cell>
                                                <fo:block font-size="10pt" text-align="left"  xsl:use-attribute-sets="labelNormal">
                          ...
                          <!-- <fo:table-cell display-align="center"> -->
                            <!-- <fo:block text-align="center"> -->
                              <!-- <fo:block margin-left="3px" margin-right="3px"> -->
                                <!-- <fo:external-graphic content-height="scale-to-fit" max-height="2.5cm"  content-width="scale-to-fit" max-width="100%"  scaling="uniform" src="url('qrcode.png')"> -->
                                <!-- </fo:external-graphic> -->
                              <!-- </fo:block> -->
                            <!-- </fo:block> -->
                          <!-- </fo:table-cell> -->
                          ...
                          <fo:table-cell padding-left="2mm">
                            <fo:block font-size="10pt" text-align="left" xsl:use-attribute-sets="labelNormal">
                              ...
                              <fo:wrapper xsl:use-attribute-sets="labelItalic">(Payment method): </fo:wrapper>
								<xsl:if test="DLHDon/TTChung/HTTToan = 'CK'">
									<fo:wrapper xsl:use-attribute-sets="labelNormal">Chuyển khoản</fo:wrapper>
								</xsl:if>
								<xsl:if test="DLHDon/TTChung/HTTToan = 'TM'">
									<fo:wrapper xsl:use-attribute-sets="labelNormal">Tiền mặt</fo:wrapper>
								</xsl:if>
								<xsl:if test="DLHDon/TTChung/HTTToan = 'TM/CK'">
									<fo:wrapper xsl:use-attribute-sets="labelNormal">Tiền mặt/Chuyển khoản</fo:wrapper>
								</xsl:if>
								<xsl:if test="DLHDon/TTChung/HTTToan != 'CK' and DLHDon/TTChung/HTTToan != 'TM' and DLHDon/TTChung/HTTToan != 'TM/CK' ">
									 <fo:inline xsl:use-attribute-sets="itemNormal">
                  ...
                  <fo:block font-size="10pt">
                    <fo:table border-collapse="collapse" table-layout="fixed" width="100%">
                      ...
                      <fo:table-body>
						...
						<xsl:choose>
						<xsl:when test="TChat != 'null' and TChat = 2">
                          <fo:table-row keep-together.within-page="always">
                            <fo:table-cell xsl:use-attribute-sets="boxSmall" display-align="center">
                              <fo:block text-align="center" xsl:use-attribute-sets="itemNormal">
                                <xsl:choose>
                            ...
                            <fo:table-cell xsl:use-attribute-sets="boxSmall" display-align="center">
								<xsl:call-template name="splitstring">
									<xsl:with-param name="num" select="THHDVu" />
								</xsl:call-template>
                            </fo:table-cell>
                            <fo:table-cell xsl:use-attribute-sets="boxSmall" display-align="center">
                        ...
                        <xsl:choose>
                          <xsl:when test="HDon/DLHDon/NDHDon/TToan/THTTLTSuat/LTSuat != ''">
                                            ...
                                            <fo:table-row>
                                              <fo:table-cell>
                                                <fo:block text-align="center">
                                                  ...
                                                  <fo:wrapper font-size="10pt"  xsl:use-attribute-sets="labelItalic">(Exchanged by)</fo:wrapper>
                                                </fo:block>
                                                <fo:block text-align="center">
                                                  <fo:inline font-size="10pt"  xsl:use-attribute-sets="labelItalic">(Ký, ghi rõ họ tên)</fo:inline>
                                                </fo:block>
                                                <fo:block text-align="center">
                                                  <fo:inline font-size="10pt"  xsl:use-attribute-sets="labelItalic">(Sign,full name)</fo:inline>
                                                </fo:block>
                                                <fo:block text-align="center">
                                                ...
                                                <fo:block text-align="center">
                                                  <fo:inline font-size="10pt" xsl:use-attribute-sets="labelNormal">${exchangeUser}</fo:inline>
                                                </fo:block>
                                                <fo:block text-align="center">
                                                  <fo:wrapper font-size="10pt"  xsl:use-attribute-sets="labelBold">Ngày chuyển đổi </fo:wrapper>
                                                  <fo:wrapper font-size="10pt" xsl:use-attribute-sets="labelItalic">(Exchange date):</fo:wrapper>
                                                  <fo:block font-size="10pt" xsl:use-attribute-sets="labelNormal">${exchangeDay}/${exchangeMonth}/${exchangeYear}</fo:block>
                                                </fo:block>
                                              </fo:table-cell>
                                              <fo:table-cell>
                                                <fo:block text-align="center">
                                                  <fo:wrapper font-size="10pt"  xsl:use-attribute-sets="labelBold">Người mua hàng </fo:wrapper>
                                                  <fo:wrapper font-size="10pt" xsl:use-attribute-sets="labelItalic">(Buyer)</fo:wrapper>
                                              ...
                                              <fo:table-cell>
                                                <fo:block text-align="center">
                                                  <fo:wrapper font-size="10pt"  xsl:use-attribute-sets="labelBold">Người bán hàng </fo:wrapper>
                                                  <fo:wrapper font-size="10pt"  xsl:use-attribute-sets="labelItalic">(Seller)</fo:wrapper>
                                                </fo:block>
                                                <fo:block text-align="center"  display-align="center">
                                                  <fo:block padding-top="7px" margin-top="7px">
                                                  </fo:block>
